	...
	<div class="main-content-inner">
		<script>
			function ubahData(id){
				...
				$.ajax({
	                url: '<?php echo site_url(); ?>/groupProduct/edit/',
	                method : "POST",
	                data : {id: id},
	                async : false,
	                dataType : 'json',
					...
					<table id="datatable" class="table table-striped table-bordered">
						<thead>
							<tr>    
								...
								<th class="center" width="85%">Keterangan</th>
								<th class="center" >
							...
							<tr>
								...
								<td align="center">
									...
									<a href="<?php echo site_url(); ?>/groupProduct/hapus/<?php echo $row['GroupProduct_auto']; ?>" class="tooltip-error" data-rel="tooltip" title="Hapus" onclick="return confirm('Apakah Anda yakin ingin menghapus data <?php echo $row['GroupProduct_auto']; ?> ?')">
										<span class="red">
