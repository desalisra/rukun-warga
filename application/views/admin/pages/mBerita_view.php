					...
					<table id="datatable" class="table table-striped table-bordered">
						<thead>
							<tr>    
								...
								<th class="center" width="20%">Judul</th>
								<th class="center" width="50%">Keterangan</th>
								<th class="center" width="15%">Tanggal Post</th>
							...
							<tr>
								...
								<td><?= substr($row->post_berita, 0,175)." ..."; ?></td>
								<td class="center"><?= $row->tgl_berita; ?></td>
								<td align="center">
									<a href="<?= base_url().'mBerita/edit/'.$row->id_berita; ?>" class="btn btn-success btn-sm" title="Edit">
