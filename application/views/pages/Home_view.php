...
<section id="content" class="mt-5  mb-5">
  <div class="container">
    <div class="row">
            ...
            <div class="tab-content">
              ...
              <div role="tabpanel" class="tab-pane" id="profilesn">
                <p>Syarat : <br>
                  ...
                  - Blanko dan Surat permohonan siap dibawa ke kecamatan / dinas terkait
                </p>
              </div>
            </div>
          </div>
            ...
            <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
              <div class="carousel-inner">
                <div class="carousel-item active">
                  <img class="d-block w-100 img-fluid" src="<?= base_url('assets/img/banner/slide1.jpg') ?>" alt="First slide">
                </div>
                <div class="carousel-item">
                  <img class="d-block w-100 img-fluid" src="<?= base_url('assets/img/banner/slide2.jpg') ?>" alt="Second slide">
                </div>
                <div class="carousel-item">
                  <img class="d-block w-100 img-fluid" src="<?= base_url('assets/img/banner/slide3.jpg') ?>" alt="Third slide">
                </div>
              </div>
      ...
      <div class="col-lg-12">
        <h3 class="text-center">JIKA ANDA MERUPAKAN WARGA BARU</h3>
        ...
        <p>Penduduk yang pindah domisili tetap perlu melapor kepada RT/RW setempat untuk berpamitan, dan melapor saat datang di tempat tujuan sekaligus mengenalkan diri ke ketua RT/RW sebagai warga baru di lingkungannya. Ini adalah bagian dari tanggung jawab moral serta menghargai adat istiadat setempat </p>
      </div>
    </div>
  </div>
</section>
